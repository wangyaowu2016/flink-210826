...
public class Flink01_TimeWindow_Sliding {
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream<String, String, TimeWindow> window = keyedStream.window(SlidingProcessingTimeWindows.of(Time.seconds(6), Time.seconds(3)));

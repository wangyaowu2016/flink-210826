...
public class Flink14_EventTime_WaterMark_ForBounded_TimeWindow_Session {
...
//        env.getConfig().setAutoWatermarkInterval(500);
        ...
        //6.开启一个基于事件时间的会话窗口
        WindowedStream<WaterSensor, String, TimeWindow> window = keyedStream.window(EventTimeSessionWindows.withGap(Time.seconds(4)));
